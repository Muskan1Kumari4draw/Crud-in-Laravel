...
<form action="{{ route('products.store') }}" method="POST">
    ...
    <div class="card-body">
        <div class="mb-3">
            ...
            <textarea type="description" class="form-control form-control-lg" placeholder="Enter Description" name="description" cols="50" rows="3">{{ old('description') }} </textarea>
        </div>
    </div>
    <div class="card-body">
        <div class="mb-3">
            <label class="form-label h4" for="">Image</label>
            <input type="file" class="form-control form-control-lg" placeholder="Enter Image" name="image">
        </div>
    </div>
    <div class="d-grid">
