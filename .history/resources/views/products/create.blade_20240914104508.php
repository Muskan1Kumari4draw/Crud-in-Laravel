...
<form action="{{ route('products.store') }}" method="POST">
    ...
    <div class="card-body">
        <div class="mb-3">
            ...
            <input type="text" class="@error('sku') is-invalid @enderror   form-control form-control-lg" name="sku" placeholder="Enter Name">
            @error('sku')
            <p class="invalid-feedback" >{{ $message }}</p>
            @enderror
        </div>
    ...
    <div class="card-body">
        <div class="mb-3">
            ...
            <textarea type="description" class="form-control form-control-lg" placeholder="Enter Description" class="form-control" name="description" cols="50" rows="3"> </textarea>
        </div>
    </div>
    <div class="card-body">
        <div class="mb-3">
            <label class="form-label h4" for="">Image</label>
            <input type="file" class="form-control form-control-lg" placeholder="Enter Name">
        </div>
    </div>
    <div class="d-grid">
