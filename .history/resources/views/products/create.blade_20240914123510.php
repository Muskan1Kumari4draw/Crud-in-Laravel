                    ...
                    <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <textarea class="form-control form-control-lg" name="description" placeholder="Enter Description" cols="50"
                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <input type="file" value="{{ old('image') }}" class="form-control form-control-lg"
                                    name="image">

    @if (session('imageName'))
        <div class="mt-3">
            <img src="{{ asset('uploads/products' . session('imageName')) }}" alt="Uploaded Image" width="150">
        </div>
    @endif
                            </div>
                        </div>
